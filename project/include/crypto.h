...
class CryptoOperation {
    ...
    public:
        ...
        unsigned int encryptMessage(unsigned char* key, unsigned char* iv, unsigned char *msg, unsigned int msg_len, vector<unsigned char> &buffer, counterSession* s);
        unsigned int decryptMessage(unsigned char* key, unsigned char *msg, unsigned int msg_len, vector<unsigned char> &buffer, counterSession* s);
